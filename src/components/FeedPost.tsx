      ...
      <div className="relative h-screen w-full snap-start snap-always overflow-hidden">
        ...
        <div className="absolute right-2 bottom-[160px] sm:right-3 sm:bottom-[180px] flex flex-col gap-3 sm:gap-4 z-30">
          ...
          >
            {isPlaying ? (
              <div className="bg-white/15 backdrop-blur-md p-2.5 rounded-full shadow-lg transition-all duration-300">
                <HeartIcon size={22} className={`transition-all duration-200 ${liked ? 'fill-white text-white' : 'text-white'}`} />
              </div>
            ) : (
              <div className="bg-gray-200/90 backdrop-blur-sm px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-full flex items-center gap-2 shadow-lg transition-all duration-300">
                <HeartIcon size={18} className={`sm:w-5 sm:h-5 transition-all duration-200 ${liked ? 'fill-red-500 text-red-500' : 'text-gray-800'}`} />
          ...
          >
            {isPlaying ? (
              <div className="bg-white/15 backdrop-blur-md p-2.5 rounded-full shadow-lg transition-all duration-300">
                <MessageCircleIcon size={22} className="text-white transition-all duration-200" />
              </div>
            ) : (
              <div className="bg-gray-200/90 backdrop-blur-sm px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-full flex items-center gap-2 shadow-lg transition-all duration-300">
                <MessageCircleIcon size={18} className="sm:w-5 sm:h-5 text-gray-800 transition-all duration-200" />
                <span className="text-gray-800 text-xs sm:text-sm font-semibold">
                  {post.comments}
                </span>
              </div>
          ...
          >
            {isPlaying ? (
              <div className="bg-white/15 backdrop-blur-md p-2.5 rounded-full shadow-lg transition-all duration-300">
                <BookmarkIcon size={22} className={`transition-all duration-200 ${saved ? 'fill-white text-white' : 'text-white'}`} />
              </div>
            ) : (
              <div className="bg-gray-200/90 backdrop-blur-sm px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-full flex items-center gap-2 shadow-lg transition-all duration-300">
                <BookmarkIcon size={18} className={`sm:w-5 sm:h-5 transition-all duration-200 ${saved ? 'fill-yellow-500 text-yellow-500' : 'text-gray-800'}`} />
                <span className="text-gray-800 text-xs sm:text-sm font-semibold">
                  {saved ? 'Saved' : 'Save'}
                </span>
              </div>
