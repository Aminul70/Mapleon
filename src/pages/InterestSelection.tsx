...
import { UtensilsCrossed, Dumbbell, Scissors, Coffee, Sparkles, LucideIcon } from 'lucide-react';
...
export function InterestSelection() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-mapleon-teal via-mapleon-gray to-mapleon-teal-tint flex items-center justify-center p-6">
          ...
          {[0, 1, 2, 3, 4].map(i => (
            <div
              ...
              className={`h-2 rounded-full transition-all duration-300 ${
                i === 1 ? 'w-8 bg-mapleon-pink' : 'w-2 bg-gray-300'
              }`}
            />
          ))}
        </div>
