                  ...
                  >
                    {formData.profileImage ? (
                      ...
                      <div className="w-32 h-32 rounded-full bg-white border-4 border-white shadow-lg flex items-center justify-center group-hover:bg-gray-50 transition-colors">
                        <div className="text-center">
                          <Camera size={40} className="text-gray-400 mx-auto mb-1 group-hover:text-business-badge group-hover:scale-110 transition-all" />
                          <p className="text-xs text-gray-500 font-medium">Add Logo</p>
                        </div>
                      </div>
                    )}
                  </button>
